...
TOOLS
- \`discard\`: remove unneeded outputs (tasks done, noise, outdated). No preservation.
...
Scenarios: task done+no value→discard | task done+insights→extract | noise→discard | valuable but large→extract
BATCH PRUNES
...
ONLY prune what's in <prunable-tools>.
</instruction>
...
NEVER say: "I agree", "I see the list", "As nudge suggests", "I've pruned X", "Context cleanup complete"
