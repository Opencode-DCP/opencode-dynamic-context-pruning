...
const COMPRESS_TRIGGER_PROMPT = [
    ...
    "Find the most significant completed conversation block or set of independent closed blocks that can be compressed into high-fidelity technical summaries.",
    "Use block priority and token metadata when helpful, choose safe block-scoped target IDs, and preserve all critical implementation details.",
    "Return after compress with a brief explanation of what block or blocks were compressed.",
].join("\n\n")
